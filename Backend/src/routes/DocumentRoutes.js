...
router.put(
  "/updateOwner/:owner",
  backendValidation,
  documentController.updateOwnerInDocuments
);
router.post(
  "/invite/:id/:email",
  backendValidation,
  documentController.inviteUser
);
router.get("/getUsers/:id", backendValidation, documentController.getUsers);
router.delete(
  "/revokeInvitation/:id/:email",
  backendValidation,
  documentController.revokeInvitation
);
router.put(
  "/updateOnlySubSectionByIds/:id/:sectionId/:subSectionId",
  backendValidation,
  documentController.updateOnlySubSectionByIds
);
router.put(
  "/updateOnlySubSectionByTitles/:id/:sectionTitle/:subSectionTitle",
  backendValidation,
  documentController.updateOnlySubSectionByTitles
);
