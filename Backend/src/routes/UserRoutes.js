...
router.put(
  "/addOwnProject/:email",
  backendValidation,
  userController.addOwnProject
);
router.put(
  "/addSharedProject/:email",
  backendValidation,
  userController.addSharedProject
);
router.put(
  "/deleteOwnProject/:email",
  backendValidation,
  userController.deleteOwnProject
);
router.put(
  "/deleteSharedProject/:email",
  backendValidation,
  userController.deleteSharedProject
);
