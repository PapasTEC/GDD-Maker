    ...
    children: [
      {
        path: "",
        loadChildren: () =>
          import("src/app/layouts/editor-layout/editor-layout.module").then(
    ...
    children: [
      {
        ...
        loadChildren: () =>
          import(
            "src/app/layouts/dashboard-layout/dashboard-layout.module"
    ...
    children: [
      {
        ...
        loadChildren: () =>
          import(
            "src/app/layouts/gdd-setup-layout/gdd-setup-layout.module"
          ).then((m) => m.GDDSetupLayoutModule),
      },
    ],
  },
  {
