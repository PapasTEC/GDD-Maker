...
export const EditorLayoutRoutes: Routes = [
    ...
    { path: 'theme', component: VditorComponent, data: {section: "High Level Design", subSection: "Theme", upload: false} },
    ...
    { path: 'visualStyle', component: VditorComponent, data: {section: "Look and Feel", subSection: "Visual Style", upload: true} },
    { path: 'userInterface', component: VditorComponent, data: {section: "Look and Feel", subSection: "User Interface", upload: true} },
    { path: 'musicSound', component: VditorComponent, data: {section: "Look and Feel", subSection: "Music and Sound", upload: true} },
    { path: 'gameReferences', component: VditorComponent, data: {section: "Game References", subSection: "Game References", upload: true} },
];
