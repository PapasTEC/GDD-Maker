...
export class UserService {
  ...
  addSharedProject(email: string, id: string) {
    return this.http.put<any>(this.API + "addSharedProject/" + email, {
      id: id,
    });
  }

  removeOwnProject(email: string, id: string) {
    return this.http.put<any>(this.API + "deleteOwnProject/" + email, {
      id: id,
    });
  }

  removeSharedProject(email: string, id: string) {
    return this.http.put<any>(this.API + "deleteSharedProject/" + email, {
      id: id,
    });
  }
